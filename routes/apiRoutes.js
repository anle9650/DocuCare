...
router.patch("/records/:id/addDiagnosis", recordsController.addDiagnosis, recordsController.respondJSON);
router.patch("/records/:id/removeDiagnosis", recordsController.removeDiagnosis, recordsController.respondJSON);
